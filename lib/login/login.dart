import 'package:diario/home.dart';
import 'package:diario/models/models.dart';
import 'package:diario/register/register.dart';
import 'package:diario/sql/sql.dart';
  ...
  return Form(
    ...
    child: Column(
      ...
      children: <Widget> [
        ...
        const SizedBox(
          child:  Text('Diario', style: TextStyle(fontSize: 45, color: Colors.black),),
        ),
         const Padding(
